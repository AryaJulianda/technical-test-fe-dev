...
const Sidebar = () => {
  return (
    <div className="w-[20%] sticky top-0 bottom-0 py-12 px-7 flex flex-col bg-white items-center gap-4">
      ...
      {/* profile */}
      <div className="bg-[#fafafa] w-full p-3 rounded-xl flex flex-row gap-3">
      ...
      {/* sidebar link */}
      <div className="flex flex-row w-full py-3 gap-4 border-e-4 border-primary-blue">
